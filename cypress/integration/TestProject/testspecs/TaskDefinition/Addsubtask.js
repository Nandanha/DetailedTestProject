...
it('Add subtask for a parent task under taskdefinition and validate', function() {
    ...
    TrinityTaskPage.filter('Newtasktest1');
    TrinityTaskPage.addsubtask('addsub','addsub desc');
    TrinityTaskPage.pageload();
    TrinityTaskPage.filter('Newtasktest1');
    TrinityTaskPage.validatesubtask('addsub');
